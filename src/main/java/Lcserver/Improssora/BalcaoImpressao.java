...
public class BalcaoImpressao {
    ...
    public void imprimir(int codBalcao, Impressora i) throws Exception {
        Balcao balcao = balcaoDao.findById(codBalcao).get();
    ...
    private void impressaoBema25004200(Balcao balcao, Impressora i) throws Exception {
        ...
        cupom += "--------------------------------------------------\n";
        cupom += Funcoes.centralizarTexto("www.lcsistemasnet.com.br " + SessaoAberta.getVersao(), 50) + "\n";
    ...
    private void impressao48(Balcao balcao, Impressora i) throws Exception {
        ...
        cupom += "------------------------------------------------\n";
        cupom += Funcoes.centralizarTexto("www.lcsistemasnet.com.br " + SessaoAberta.getVersao(), 48) + "\n";
        System.out.println(cupom);
    ...
    private void impressao42(Balcao balcao, Impressora i) throws Exception {
        ...
        cupom += "------------------------------------------\n";
        cupom += Funcoes.centralizarTexto("www.lcsistemasnet.com.br " + SessaoAberta.getVersao(), 42) + "\n";
        System.out.println(cupom);
        print.imprimir(cupom);
        print.acionaGuilhotina();
    }
