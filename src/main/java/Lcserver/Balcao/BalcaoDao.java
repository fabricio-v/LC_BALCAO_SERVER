...
public interface BalcaoDao extends JpaRepository<Balcao, Integer> {
    ...
    @Query(value = "select new Balcao (b.id,b.empresa,b.usuario,b.cliente,b.dataHora,b.total,b.descTipo,b.descForma,b.desconto,b.valorDesconto,b.arredondamento,b.subTotal,b.status,b.obs) from Balcao b WHERE (b.id like str(?1) or b.cliente.nome like ?1 or b.cliente.cpfCnpj like ?1 or b.cliente.razaoSocial like ?1) and b.usuario.id like str(?2) and b.status!='PF' and b.status!='EX' order by b.id desc")
    List<Balcao> getBalcaoListSemDetByIdByClienteNomeByCpfCnpjByRazaoAndPFByUser(String nome, String idUsuario, Pageable pageable);
